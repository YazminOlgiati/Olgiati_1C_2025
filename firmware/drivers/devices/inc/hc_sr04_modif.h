...
/**
 * @brief Lee la distancia en centímetros usando un sensor HC-SR04 específico.
 * 
 * @param trigger_pin GPIO del pin trigger
 * @param echo_pin GPIO del pin echo
 * @return Distancia en centímetros
 */
uint16_t HcSr04ReadDistanceInCentimeters(gpio_t trigger_pin, gpio_t echo_pin);
